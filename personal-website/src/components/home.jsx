    ...
    <div className="bg-white">
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="flex items-center justify-center pt-20 flex-col">
          ...
          <img
            className="inline-block rounded-full overflow-hidden m-16"
            src={ProfilePicture}
            alt="Profile Picture"
            width="270"
            height="270"
        ...
        {/* Projects */}
        <Element id="projects-section" ref={projectsRef}>
          <div className=" pb-24 sm:py-32">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-2xl sm:text-center">
                <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl pt-72">
                  My Projects
                </h2>
              </div>
              {/* ACU */}
